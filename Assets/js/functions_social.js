var tableDocumentosSocial;

document.addEventListener('DOMContentLoaded', function () {

    tableDocumentosSocial = $('#tableDocumentosSocial').dataTable({
        "aProcessing": true,
        "aServerSide": true,
        "language": {
        ...
        "ajax": {
            "url": " " + base_url + "/Social/getDocumentosSocial",
            "dataSrc": ""
        ...
        "columns": [          
            ...
            { "data": "fecha_recepcion" },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return '<a href="/sis_registro/Assets/archivos_doc/Participacion_Social/' + data + '" target="_blank">' + icono + '</a>';
                }
            },
            { "data": "options" }
...
function btnVerDocumentoSocial(id_doc) {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 && request.status == 200) {
            ...
            if (objData.status) {
                ...
                $('#modalVerDocumentoSocial').modal('show');
            } else {
            ...
            xhttp.onreadystatechange = function () {
                if (xhttp.readyState == 4 && xhttp.status == 200) {
                    ...
                    if (result.status) {
                        ...
                        tableDocumentosSocial.api().ajax.reload();
                    } else {
                        Swal.fire({
                            icon: 'error',
