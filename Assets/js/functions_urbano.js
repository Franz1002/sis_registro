var tableDocumentosUrbanos;

document.addEventListener('DOMContentLoaded', function () {

    tableDocumentosUrbanos = $('#tableDocumentosUrbanos').dataTable({
        "aProcessing": true,
        "aServerSide": true,
        "language": {
        ...
        "ajax": {
            "url": " " + base_url + "/Urbano/getDocumentosUrbanos",
            "dataSrc": ""
        ...
        "columns": [          
            ...
            { "data": "fecha_recepcion" },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return '<a href="/sis_registro/Assets/archivos_doc/Seguimiento_Urbano/' + data + '" target="_blank">' + icono + '</a>';
                }
            },
            { "data": "options" }
...
function btnVerDocumentoUrbano(id_doc) {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 && request.status == 200) {
            ...
            if (objData.status) {
                ...
                $('#modalVerDocumentoUrbano').modal('show');
            } else {
            ...
            xhttp.onreadystatechange = function () {
                if (xhttp.readyState == 4 && xhttp.status == 200) {
                    ...
                    if (result.status) {
                        ...
                        tableDocumentosUrbanos.api().ajax.reload();
                    } else {
                        Swal.fire({
                            icon: 'error',
