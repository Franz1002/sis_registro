var tableDocumentosRural;

document.addEventListener('DOMContentLoaded', function () {

    tableDocumentosRural = $('#tableDocumentosRural').dataTable({
        "aProcessing": true,
        "aServerSide": true,
        "language": {
        ...
        "ajax": {
            "url": " " + base_url + "/Rural/getDocumentosRural",
            "dataSrc": ""
        ...
        "columns": [          
            ...
            { "data": "fecha_recepcion" },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return '<a href="/sis_registro/Assets/archivos_doc/Seguimiento_Rural/' + data + '" target="_blank">' + icono + '</a>';
                }
            },
            { "data": "options" }
...
function btnVerDocumentoRural(id_doc) {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 && request.status == 200) {
            ...
            if (objData.status) {
                ...
                $('#modalVerDocumentoRural').modal('show');
            } else {
            ...
            xhttp.onreadystatechange = function () {
                if (xhttp.readyState == 4 && xhttp.status == 200) {
                    ...
                    if (result.status) {
                        ...
                        tableDocumentosRural.api().ajax.reload();
                    } else {
                        Swal.fire({
                            icon: 'error',
