var tableDocumentosRrhh;

document.addEventListener('DOMContentLoaded', function () {

    tableDocumentosRrhh = $('#tableDocumentosRrhh').dataTable({
        "aProcessing": true,
        "aServerSide": true,
        "language": {
        ...
        "ajax": {
            "url": " " + base_url + "/Rrhh/getDocumentosRrhh",
            "dataSrc": ""
        ...
        "columns": [          
            ...
            { "data": "fecha_recepcion" },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return '<a href="/sis_registro/Assets/archivos_doc/Recursos_Humanos/' + data + '" target="_blank">' + icono + ' </a>';
                }
            },
            { "data": "options" }
...
function btnVerDocumentoRrhh(id_doc) {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 && request.status == 200) {
            ...
            if (objData.status) {
                ...
                $('#modalVerDocumentoRrhh').modal('show');
            } else {
            ...
            xhttp.onreadystatechange = function () {
                if (xhttp.readyState == 4 && xhttp.status == 200) {
                    ...
                    if (result.status) {
                        ...
                        tableDocumentosRrhh.api().ajax.reload();
                    } else {
                        Swal.fire({
                            icon: 'error',
