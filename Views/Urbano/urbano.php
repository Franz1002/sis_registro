                ...
                <div class="tile">
                  <div class="tile-body">
                    <div class="table-responsive">
                      <table class="table table-hover table-bordered" id="tableDocumentosUrbanos">
                        <thead>
                          <tr>
...
<div class="modal fade" id="modalVerDocumentoUrbano" tabindex="-1" role="dialog" aria-hidden="true">
