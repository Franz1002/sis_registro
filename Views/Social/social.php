                ...
                <div class="tile">
                  <div class="tile-body">
                    <div class="table-responsive">
                      <table class="table table-hover table-bordered" id="tableDocumentosSocial">
                        <thead>
                          <tr>
                            <th>Hoja de ruta</th>
                            <th>Título</th>
...
<div class="modal fade" id="modalVerDocumentoSocial" tabindex="-1" role="dialog" aria-hidden="true">
