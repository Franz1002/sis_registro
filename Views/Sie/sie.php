                ...
                <div class="tile">
                  <div class="tile-body">
                    <div class="table-responsive">
                      <table class="table table-hover table-bordered" id="tableDocumentosSie">
                        <thead>
                          <tr>
                            <th>Hoja de ruta</th>
                            <th>Título</th>
...
<div class="modal fade" id="modalVerDocumentoSie" tabindex="-1" role="dialog" aria-hidden="true">
